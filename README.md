...
struct Divesh {
    ...
    education:   "B.Tech CSE — Chennai Institute of Technology (2024–2028) · CGPA 7.65↑",
    ...
    building:    ["APEX-Bot (Rust · Solana · mainnet live)",
                  "P.E.E.R (Google Solution Challenge 2025)"],
    prize_money: "$4,650+ across 70+ hackathons",
    top_wins:    [
        "QIE Blockchain Hackathon — Top 3 Podium ($2,500) 🥇",
        "Cardano IBW Asia 2025 — Winner ($2,000) 🥇",
        "Beach Hack 2026 — 2nd Place (₹20,000) 🥈",
        "BNB Hack Bombay — Winner ($150) 🏅",
    ],
    interests:   ["RL + HRI", "DeFi/Solana", "Crypto/Forex", "Powerlifting"],
    status:      "open_to_collabs(domain: Web3 | AI | Research)",
}
```
...
### ⚡ APEX-Bot
> Rust-based Solana memecoin sniper on **mainnet**. Real-time WebSocket price feeds, stop-loss logic, priority fee management, PnL reporting.
...
### 🤖 ZETA Framework *(IEEE ICOSEC 2025)*
> Zero-Shot Embodied Task Automator — FLM-driven hierarchical planner + affordance skill selection + sensor-feedback loop. **96–100% task success** in PyBullet.
...
### 🌍 P.E.E.R *(Google Solution Challenge 2025)*
> 100% offline-first AI education for rural schools — SDG 4. On-device LLM (Gemma-2B), RAG over NCERT, Bluetooth P2P sync, ESP32 BLE reminders.

`Python` `Next.js` `ESP32` `Gemma-2B`

</td>
<td width="50%" valign="top">

### 🏆 Lendora AI *($2,000 · Cardano IBW Asia)*
> AI-powered DeFi lending on Cardano. Risk-adaptive collateral, real-time credit scoring. **Best UI/UX + Best Hydra Implementation.**

`Cardano` `Solidity` `wagmi` `Next.js`
...
### 🧠 NeuroCred *($2,500 · QIE Hackathon)*
> On-chain AI credit passport on QIE Blockchain (25,000 TPS). Live deployed. **Top 3 Podium — Neural Chain Award.**

`QIE Blockchain` `Solidity` `Next.js` `AI`

</td>
<td width="50%" valign="top">

### ✅ VeriField *($150 · BNB Hack Bombay)*
> DeSci DataNFT marketplace. AI-powered semantic search, BNB Greenfield storage. **Best Greenfield Implementation.**

`BNB Chain` `Greenfield` `Solidity` `React`
...
### 💸 BitLend *(Bitcoin++ Most Educational)*
> Wallet-native DeFi lending with on-chain credit guardrails. Presented at Bitcoin++ Global Hackathon.

`Bitcoin` `Solidity` `Ethers.js` `Next.js`

</td>
<td width="50%" valign="top">

### 🔗 Avalanche Arena
> Cross-game soulbound identity layer — evolving IdentityNFT (6 tiers, on-chain SVG), EIP-191 proof indexer, 59 contract tests, 5-job CI/CD.

`Avalanche` `Solidity` `Hardhat` `TypeScript`
...
### 🔍 ScoutX
> On-chain talent discovery + reputation verification for Web3 hiring. Soulbound credentials, verifiable work history.

`Solana` `TypeScript` `Next.js` `SBTs`

</td>
<td width="50%" valign="top">

### 🤝 Haggle.AI + SynthIQ
> **Haggle.AI:** Multi-strategy autonomous LLM negotiation agent. **SynthIQ:** Multi-agent research summariser with knowledge graph UI.

`FastAPI` `LLMs` `React` `Multi-Agent`
...
@inproceedings{divesh2025zeta,
  ...
  author    = {Divesh Kumar S and Dhev Arjun A I
               and M. Maharasi and Dr. S. Pavithra Sankarappan},
  booktitle = {6th Intl. Conference on Smart Electronics
               and Communication (ICOSEC-2025)},
  publisher = {IEEE},
  pages     = {1777--1783},
  isbn      = {979-8-3315-9859-4},
  year      = {2025},
  note      = {In Press — IEEE Xplore}
}
```

> **[2]** Divesh Kumar S et al. · *"Colon Polyp & Cancer Cell Detection — DL + Hyperspectral Imaging"*
...
```
╔══════════════════════════════════════════════════════════════════════╗
║                   HACKATHON RECORD  (70+ competed)                  ║
╠══════════════════════════════════════════════════════════════════════╣
║  🥇  QIE Blockchain Hackathon 2025 — Top 3 Podium ...... $2,500    ║
║        Neural Chain Award · NeuroCred                               ║
║  🥇  Cardano IBW Asia Hackathon 2025 — Winner .......... $2,000    ║
║        Best UI/UX + Best Hydra Implementation · Lendora AI          ║
║  🥈  Beach Hack 2026 — 2nd Place ................... ₹20,000       ║
║        36hr national offline · Kerala                               ║
║  🏅  BNB Hack Bombay 2025 — Winner .................... $150       ║
║        Best Greenfield Implementation · VeriField                   ║
║  🎤  Bitcoin++ Global Hackathon — Most Educational                  ║
║  🏛️  IIT Madras Smart Hostel Hackathon — Finalist  (Top 25)         ║
║  ⚡  Micro Labs Fever Hackathon 2025 — Top 15  (Bangalore offline)  ║
║  🔥  GDG On Campus CIT TechSprint — Top 8  (Team Horizon)          ║
║  🛡️  ExploiX CTF CIT — Finalist Top 40  (blockchain/exploit)       ║
║  🌐  AWS & NVIDIA Agentic AI Hackathon — Participant                ║
║  ☁️  Google Cloud Run Hackathon — Participant                       ║
╠══════════════════════════════════════════════════════════════════════╣
║                      RESEARCH & ACADEMICS                           ║
╠══════════════════════════════════════════════════════════════════════╣
║  📄  IEEE ICOSEC 2025 — Published .............. pp. 1777–1783     ║
║  🔑  ORCID: 0009-0001-1138-1529                                     ║
║  💻  LeetCode 118+ solved · Contest Rating 1492                     ║
╚══════════════════════════════════════════════════════════════════════╝

                      Total Prize Money: $4,650+
```
...
<div align="center">
  <sub>⚡ Always open to collabs in <b>Web3 × AI × Research</b> — let's build something real.</sub>
</div>
